...
- (id)initWithCoder:(NSCoder*)coder
{
	...
	if (self) {
        ...
        if(MIN(w, h) == 640 && MAX(w, h) == 960) { // Retina display detected 
        ...
        VBEngineStart([[[NSBundle mainBundle] resourcePath] UTF8String], [documentDirectory UTF8String], MAX(w, h), MIN(w, h), 960, 640);
    }
