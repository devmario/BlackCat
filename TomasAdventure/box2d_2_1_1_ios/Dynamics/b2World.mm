...
void b2World::DrawJoint(b2Joint* joint)
{
	...
	b2Color color(0.5f, 0.8f, 0.8f, 1.0);
...
void b2World::DrawDebugData()
{
	...
	if (flags & b2Draw::e_shapeBit)
	{
		for (b2Body* b = m_bodyList; b; b = b->GetNext())
		{
			...
			for (b2Fixture* f = b->GetFixtureList(); f; f = f->GetNext())
			{
                ...
                if(obj->body->IsActive()  == false)
                    continue;
                switch (obj->type) {
                    case BodyGround:
                        DrawShape(f, xf, b2Color(0.5, 0.5, 0.0, 1.0));
                        break;
                    case BodyTomasBody:
                        DrawShape(f, xf, b2Color(1.0, 1.0, 1.0, 0.5));
                        break;
                    case BodyTomasLeg:
                        DrawShape(f, xf, b2Color(1.0, 1.0, 1.0, 1.0));
                        break;
                    case BodySave:
                        DrawShape(f, xf, b2Color(0.0, 0.0, 1.0, 0.3));
                        break;
                    case BodyDie:
                        DrawShape(f, xf, b2Color(1.0, 0.0, 0.0, 0.3));
                        break;
                    case BodyEnd:
                        DrawShape(f, xf, b2Color(0.0, 1.0, 0.0, 0.3));
                        break;
                    case BodyItemRope:
                        DrawShape(f, xf, b2Color(0.0, 0.0, 1.0, 1.0));
                        break;
                    case BodyItemBow:
                        DrawShape(f, xf, b2Color(0.0, 0.0, 1.0, 1.0));
                        break;
                    ...
                    case BodyArrowHit:
                        DrawShape(f, xf, b2Color(0.5, 0.5, 0.0, 1.0));
                        break;
                    case BodyArrowGuideOn:
                        DrawShape(f, xf, b2Color(1.0, 1.0, 1.0, 1.0));
                        break;
                    case BodyArrowGuideOff:
                        DrawShape(f, xf, b2Color(1.0, 0.0, 0.0, 1.0));
                        break;
                }
                if(obj->type > 3000) {
                    DrawShape(f, xf, b2Color(0.2, 0.2, 0.2, 0.1));
                }
			}
		}
	}
	...
	{
		b2Color color(0.3f, 0.9f, 0.9f,1.0);
	...
	{
		b2Color color(0.9f, 0.3f, 0.9f,1.0);
